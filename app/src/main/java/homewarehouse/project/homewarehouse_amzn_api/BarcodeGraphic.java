...
import homewarehouse.project.homewarehouse_amzn_api.GraphicOverlay.Graphic;
...
public class BarcodeGraphic extends Graphic {
  ...
  public void draw(Canvas canvas) {
    ...
    canvas.drawText("Barcode Found: " + barcode.getRawValue(), rect.left, rect.bottom, barcodePaint);
  }
}
